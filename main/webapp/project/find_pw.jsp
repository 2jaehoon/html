									...
									<dl>
										...
										<dd>
											<span class="form_text">
												<input class="required-value" id="username" name="username" placeholder="아이디(이메일) 입력" type="text" value="" />
											</span>
										</dd>
										<dt>이름</dt>
										<dd>
										...
										<dt id="email_num" >휴대전화</dt>
										<dd>
											<span class="form_text">
												<input class="required-value" id="password" name="password" placeholder="'-'를 제외한 휴대전화 입력" type="password" />
											</span>
										</dd>
									</dl>
									
										<!-- 인증 버튼 추가 -->
										<input type="button"id="confirmNum"name="confirmNum"style="width: 70px; height:35px"value="인증"/>
								</div>
							</div>
						</div>
					</div>
					<div class="signin_btn">
						<a class="btn bgc_point on" href="http://localhost/html_prj/project/reset_pw.jsp" id="loginBtn" style="width:50px;"><span>비밀번호 찾기</span></a>
