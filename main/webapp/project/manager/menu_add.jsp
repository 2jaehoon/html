		...
		<div id="menu_addDiv" class="dropdown section">
			...
			<div class="section">
				...
				<table border="1" id="list">
					...
					<tr>
						<th><label>빵</label></th>
						<td><input type="text" placeholder="추가할 빵" /></td>
					</tr>
					<tr>
						<th><label>치즈</label></th>
						<td><input type="text" placeholder="추가할 치즈" /></td>
					</tr>
					<tr>
						<th><label>야채</label></th>
						<td><input type="text" placeholder="추가할 야채" /></td>
					</tr>
					<tr>
						<th><label>소스명</label></th>
						<td><input type="text" placeholder="추가할 소스명" /></td>
					</tr>
					<tr>
						<th><label>주재료</label></th>
						<td><input type="text" placeholder="추가할 주재료" /></td>
					</tr>
