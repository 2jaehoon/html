...
<script type="text/javascript">
	...
	<link rel="stylesheet" type="text/css" href="http://localhost/html_prj/project/css/recent_order/ui.mypage.css" />
	<script type="text/javascript" src="http://localhost/html_prj/project/js/recent_order/list.js"></script>
</head>
<body>
...
<!--// inc header e -->
		...
		<div id="content">
			...
			<div class="order_wrapper">
				...
				<div class="data_none2"> <!-- common.css -->
					<table>
						<tr>
							<th>날짜</th>
							<th>메뉴명</th>
