			...
			<div id="content">
				...
				<div class="franchise_wrapper">
						...
						<ul>
							<li>
								...
								<ul>
									...
									<li>· 전세계 1만 4천여개 매장으로 검증된 안정성</li>    <!-- 매장 수 변경 요청 (issues/600) -->
					...
					<div class="franchise_process">
						<h3> 가맹점 개설 절차</h3>
						<p class="summary">높은 수익성과 탁월한 안정성이 전세계 104개국, 37,525여개 매장으로 검증된 글로벌 No.1 프랜차이즈 써브웨이<br />체계화된 성공
